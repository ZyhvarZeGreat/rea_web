...
const page = (props: Props) => {
  return (
    <div className="flex w-full items-center justify-center px-6">
      <div className="scrollbar-thin   scrollbar-track-rounded-full scrollbar-thumb-rounded-full  scrollbar-thumb-[#8459FF] scrollbar-track-[#D9D9D9] no-scrollbar h-[70%]  overflow-x-hidden overflow-y-scroll  xl:max-w-4xl">
        <div className="flex h-full w-full flex-col gap-16 bg-white px-4">
          <div className="flex w-full flex-col items-start justify-center gap-6">
            <div className="mt-6 flex flex-col gap-6">
              <div className="flex flex-col">
                <h3 className="text-3xl font-semibold">Ace Glow VI</h3>
            ...
            <div className="flex w-full items-center justify-center">
              <Card className=" mt-4 flex  w-10/12 items-center justify-center    py-2 shadow-lg">
          ...
          <div className="flex w-full   flex-col items-center justify-start gap-6   sm:items-start sm:justify-center">
            ...
            <div className=" flex flex-col gap-4 text-base text-[#6D6D6D]">
              <p>
                ...
                Voluptatem blanditiis architecto odio deserunt dolorum libero
                sequi fugit fugiat, inventore est dolore nesciunt, eos nam
                similique incidunt commodi! Exercitationem recusandae
                consequuntur, non numquam vero repellendus commodi quidem iure
                similique rem necessitatibus?
              </p>
            </div>
          </div>
          ...
          <div className="flex w-full flex-col  items-center justify-center gap-6 text-center   ">
            ...
            {/*      indicator: "bg-[#4E23CB]",*/}
            {/*      label: "tracking-wider text-sm font-medium text-[#6d6d6d]",*/}
